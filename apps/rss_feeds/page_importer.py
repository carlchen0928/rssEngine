            ...
            if any(feed_link.startswith(s) for s in BROKEN_PAGES):
                ...
                if urllib_fallback:
                    ...
                    try:
                        ...
                        response = requests.get(feed_link, headers=self.headers, proxies=proxy)
                    except requests.exceptions.TooManyRedirects:
                        response = requests.get(feed_link, proxies=proxy)
